...
javac -encoding utf-8 -d %out_path% -cp .;./out;./fast-lib/fastexcel-reader-0.15.7.jar FastBenchmarkTest.java
...
javac -encoding utf-8 -d %out_path% -cp .;./out;./fast-lib/commons-compress-1.23.0.jar;./fast-lib/stax2-api-4.2.jar;./fast-lib/aalto-xml-1.3.2.jar;./fast-lib/fastexcel-0.15.7.jar FastWriteBenchmarkTest.java
