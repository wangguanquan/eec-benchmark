java -cp .:./eec-lib/dom4j-2.1.3.jar:./eec-lib/slf4j-api-1.7.32.jar:./eec-lib/eec-0.5.11.jar Warmup
java -cp .:./eec-lib/dom4j-2.1.3.jar:./eec-lib/slf4j-api-1.7.32.jar:./eec-lib/eec-0.5.11.jar EecBenchmarkTest
